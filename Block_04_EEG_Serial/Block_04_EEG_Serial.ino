...
// High-speed EEG streaming over Serial in CSV format.
// Compatible with Python / Processing for real-time analysis.
// WIRING: EEG OUT -> A0 | VCC -> 3.3V | GND -> GND
// OUTPUT FORMAT: timestamp_ms, raw_value, voltage
