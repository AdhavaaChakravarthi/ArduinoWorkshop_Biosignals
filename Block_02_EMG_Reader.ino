...
// 🧱 BLOCK 02 — EMG Reader
// ═══════════════════════════════════════════════════
// WHAT IT DOES: Reads EMG (muscle) signal, applies
//               moving average smoothing, detects
//               muscle activation via threshold.
// WORKS WITH:  MyoWare Muscle Sensor / generic EMG
// WIRING: Sensor SIG → A0 | VCC → 5V | GND → GND
// ═══════════════════════════════════════════════════

const int SENSOR_PIN     = A0;
const int WINDOW_SIZE    = 10;
const int THRESHOLD      = 600;   // Adjust 0–1023
const int SAMPLE_DELAY   = 5;     // 5ms = 200 Hz
